package com.restonli.app.config;
...
@Configuration
@EnableMongoRepositories("com.restonli.app.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.restonli.app.config.dbmigrations");
